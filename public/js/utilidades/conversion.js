...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function convertir() {
    ...
    const resF = resultado.toLocaleString(isEn ? 'en-US' : 'es-ES', { maximumFractionDigits: 4 });
    ...
    resultDiv.innerHTML = `
      <div class="resumen-calculo">
        <p class="conversion-resultado">${textoResultado}</p>
        <button class="btn-copy" data-copy-text="${textoResultado}">
          ${labels.btnCopy}
        </button>
      </div>
    `;
